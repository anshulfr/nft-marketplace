...
export const GET_COMMUNITY_ALL_USER = async () => {
...
export const GET_COMMUNITY_USER_FRIEND_LIST = async () => {
  try {
    const COMMUNITY_CONTRACT = await CALLING_CONTRACT(
      COMMUNITY_ADDRESS,
      COMMUNITY_ABI
...
// - GET_COMMUNITY_USER_MESSAGE
export const GET_COMMUNITY_USER_MESSAGE = async (address, currentUser) => {
  try {
    const COMMUNITY_CONTRACT = await CALLING_CONTRACT(
      COMMUNITY_ADDRESS,
      COMMUNITY_ABI
