...
const DashboardFriends = ({ creators, currentAccount }) => {
  return (
    <>
              ...
              .map((creator, i) => (
                ...
                >
                  <tr>
                    ...
                    <td className="px-3 py-2">
                      <p>{shortenAddress(creator.pubkey)}</p>
                    </td>
                    ...
                    <td className="px-3 py-2">
                      <a
                        href={`/chat?name=${creator?.name}&address=${creator?.pubkey}&currentUser=${currentAccount}`}
                      >
                        Send
                      </a>
                    </td>
